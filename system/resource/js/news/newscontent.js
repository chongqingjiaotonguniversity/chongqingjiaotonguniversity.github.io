...
function shareto(a,U,T,S,key)  
{
    ...
    A = '../../news/weiboshare.htm'/*tpa=http://yjszs.cqjtu.edu.cn/system/resource/news/weiboshare.htm*/;
...
function download_news(contentid,treeid,owner,newsid)
{
    if(checkobj_content(contentid))
    {
        ...
        {
            location.href='../../news/newstoword.jsp-treeid=.htm'/*tpa=http://yjszs.cqjtu.edu.cn/system/resource/news/newstoword.jsp?treeid=*/+treeid+'&owner='+owner+'&wbnewsid='+newsid;
        }
    }else{
        location.href='../../news/newstoword.jsp-treeid=.htm'/*tpa=http://yjszs.cqjtu.edu.cn/system/resource/news/newstoword.jsp?treeid=*/+treeid+'&owner='+owner+'&wbnewsid='+newsid;
    }

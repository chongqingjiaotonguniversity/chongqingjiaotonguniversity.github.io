...
function getClickTimes(newsid, owner,type,randomid) { 
    var url = '../code/news/click/clicktimes.jsp.htm'/*tpa=http://yjszs.cqjtu.edu.cn/system/resource/code/news/click/clicktimes.jsp*/; 
    if(!type) type="wbnews";
    if(!randomid)
    {
    	 randomid="n";
...
function _getBatchClickTimes(newsid, owner,type,randomid) { 
    var url = '../code/news/click/batchclicktimes.jsp.htm'/*tpa=http://yjszs.cqjtu.edu.cn/system/resource/code/news/click/batchclicktimes.jsp*/; 
    if(!type) type="wbnews";
    if(!randomid)
    {
    	 randomid="n";
...
function addClickTimes(urlid,owner,type){
		var url = '../code/news/click/addclicktimes.jsp.htm'/*tpa=http://yjszs.cqjtu.edu.cn/system/resource/code/news/click/addclicktimes.jsp*/; 
        var xmlHttp = createXMLHttpRequest();
